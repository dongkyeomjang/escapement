...
**Concurrency above ten is not confirmed.** Model accuracy degrades above the admission ceiling, and cells there are reported as exploratory throughout.
...
**A systematic residual is unexplained.** Across five device confirmations the measured ratio exceeded the prediction every time. The magnitudes never overturned a verdict; the sign is systematic and the responsible term is not identified.
